...
export function Sidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-10 flex w-64 flex-col border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div className="flex h-16 items-center gap-2 border-b border-gray-200 px-6 dark:border-gray-800">
        ...
        <span className="text-lg font-bold text-gray-900 dark:text-white">AI Creator Hub</span>
      </div>
